                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-10 lg:mb-14">
                    ...
                    <div className="flex flex-col">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2.5 mt-6 text-white/60 hover:text-white text-[0.85rem] font-outfit transition-all duration-500 w-fit group"
                        >
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-[0.6rem] text-white/50 font-outfit mt-6 tracking-[0.2em] uppercase font-medium">
